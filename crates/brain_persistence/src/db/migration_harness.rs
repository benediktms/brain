...
fn snapshot_at_version(version: i32) -> Connection {
    ...
    for v in 0..version {
        match v {
            ...
            43 => migrate_v43_to_v44(&conn).unwrap(),
            44 => migrate_v44_to_v45(&conn).unwrap(),
            ...
            53 => migrate_v53_to_v54(&conn).unwrap(),
            54 => migrate_v54_to_v55(&conn).unwrap(),
