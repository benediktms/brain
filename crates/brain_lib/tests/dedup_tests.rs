...
//! similarity) due to the avalanche effect of BLAKE3.  Use identical content
...
///
/// BLAKE3-hashed vectors for different strings have very low cosine similarity
/// (well below the 0.95 threshold), so this test reliably verifies the
/// non-duplicate path.
#[test]
