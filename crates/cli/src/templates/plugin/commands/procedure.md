...
Procedures are indexed for semantic search and can be found via `/search`. Use procedures for repeatable workflows — use `/write-episode` for one-time events.
