...
argument-hint: <topic> [--budget] [--brains] | --commit <title> <content> <source-ids>
---
...
**Typical workflow:**
1. `/reflect <topic>` — retrieve source material (prepare mode)
2. Synthesize the material into insights
3. `/reflect --commit` — store the synthesis with source links (commit mode)
